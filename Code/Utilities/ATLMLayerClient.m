...
- (NSUInteger)countOfUnreadMessages
{
    ...
    LYRPredicate *userPred = [LYRPredicate predicateWithProperty:@"sender.userID" predicateOperator:LYRPredicateOperatorIsNotEqualTo value:self.authenticatedUser.userID];
